function [error, train_time, test_time, svm_struct_train, predicted_labels] = onevR_noconf(l_train, l_test, training_data, test_data, kernel_parameters, conmat_title, conmat_filename)
